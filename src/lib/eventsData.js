export const events = [
  {
    ...
    endDate: "2026-09-12",
    highlight: "EarnX is running a +20% Torox boost for one month.",
    details: [
      "Boost: +20% on Torox offers.",
      "Promo window: August 12 to September 12.",
      "Best used for medium and high-value Torox offers.",
    ],
  },
  {
    title: "SharkEarnings $100 myChips Tournament",
    siteName: "SharkEarnings",
    siteUrl: "https://sharkearnings.com/r/netrox",
    dateRange: "Aug 10 - Aug 22",
    startDate: "2026-08-10",
    endDate: "2026-08-22",
    highlight: "Compete in SharkEarnings' $100 myChips tournament from August 10 to August 22.",
    details: [
      "Prize pool: $100.",
      "Complete myChips offers to earn leaderboard points.",
      "Event runs from August 10 through August 22.",
    ],
  },
  {
    title: "Earnlab Prime Surveys +50% Bonus",
    siteName: "Earnlab",
    siteUrl: "https://earnlab.com/r/netrox",
    dateRange: "Aug 12 - Aug 16",
    startDate: "2026-08-12",
    endDate: "2026-08-16",
    highlight: "Earnlab is offering a +50% bonus on Prime Surveys from August 12 to August 16.",
    details: [
      "Bonus: +50% on Prime Surveys.",
      "Promo dates: August 12 to August 16.",
      "Great short window for survey-focused grinding.",
    ],
  },
  {
    title: "RewardFlow $100 WaxRewards & Exclusive Offers Leaderboard",
    siteName: "RewardFlow",
    siteUrl: "https://rewardflow.me/?ref=NETROX",
    dateRange: "Ends in 15 days",
    startDate: "2026-08-12",
    endDate: "2026-08-27",
    highlight: "RewardFlow is running a $100 WaxRewards and Exclusive Offers leaderboard with 15 days remaining.",
    details: [
      "Prize pool: $100.",
      "Includes WaxRewards and Exclusive Offers leaderboard activity.",
      "Ends in 15 days - start now to climb the rankings.",
    ],
  },
  {
