export const guides = [
  {
    ...
    difficulty: "Medium",
    timeInvestment: "10-15 days",
    totalReward: "$600 - $1,050",
    sections: [
      {
        title: "Rewards Breakdown",
        content: [
          { type: "subtitle", text: "Turbo Tasks (Timed)" },
          { type: "list", items: ["Reach Island 68: $15-25 (3 days)", "Reach Island 250: $50-70 (10 days)", "Reach Island 600: $150-210 (18 days)"] },
          { type: "subtitle", text: "Spending Tasks" },
          { type: "list", items: ["Spend €3: $5-7", "Spend €18: $15-18", "Spend €52: $35-46", "Spend €100: $55-75"] },
          { type: "subtitle", text: "Island Milestones (selected)" },
          { type: "list", items: ["Island 120: $0.75 | Island 150: $1.12 | Island 200: $2.25", "Island 300: $7.50 | Island 500: $26.25 | Island 800: $56.25", "Island 1000: $93.75 | Island 1500: $300.00"] },
        ]
      },
      {
        title: "Getting Started",
        content: [
          { type: "tip", text: "Creating a Facebook account is recommended." },
          { type: "steps", items: ["Download Animal and Coins on iOS or Android", "Play until Island 5", "STOP PLAYING at Island 5", "Focus on building your friend network first"] },
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          { type: "subtitle", text: "STEAL Mechanic" },
          { type: "list", items: ["3x3 grid of targets", "Avoid tapping bombs", "Bomb-free hits give maximum coins"] },
          { type: "subtitle", text: "ATTACK Mechanic (Most Important!)" },
          { type: "warning", text: "NEVER tap a random target. Always tap the FRIENDS button. Friend attacks give 100x to 500x more coins than bots." },
          { type: "list", items: ["Select the highest-star friend available", "Shield hit = 33% coins | Direct hit = 100% coins"] },
        ]
      },
      {
        title: "Energy and Spin Management",
        content: [
      ...
      {
        title: "Time Management (VERY IMPORTANT)",
        content: [
          { type: "callout", text: "Animals & Coins rewards patience and timing more than constant play." },
          { type: "list", items: ["If no friends available to attack: Close the game", "Come back in 2-4 hours", "Check if people got online & if you can attack them", "Do NOT spam attacks or waste energy"] },
          { type: "tip", text: "Being smart about when you play is more valuable than grinding constantly." },
        ]
      },
      {
        title: "Spending Strategy",
        content: [
          { type: "list", items: ["€3 spending task is always worth it", "Spend on objects for events that give a lot of energy", "€18+ only if you aim for Island 500+", "€52+ and €100 only for very high island pushes"] },
        ]
      },
    ],
    sites: [
    ...
    sections: [
      {
        title: "Offer Overview",
        content: [
          { type: "callout", text: "High Reward Alert: While this offer requires time investment (50-90 hours), the payout makes it one of the most profitable offers available. Perfect for players who enjoy idle/tycoon games!" },
          { type: "text", text: "Eatventure is a restaurant idle/tycoon game where you build and upgrade food businesses to grow income and expand to new cities." },
        ]
      },
      {
        title: "Vault System",
        content: [
          { type: "text", text: "The Vault contains cards that give permanent boosts when leveled up. This is one of the most important progression systems." },
          { type: "subtitle", text: "Priority Upgrades - Early Game" },
          { type: "list", items: ["Tip Jar: Increases the chance of receiving tips", "Remote / Pickaxe: Helps progression in Adventure maps", "TV: Lengthens ad boosts you activate"] },
          { type: "tip", text: "Vault boosts stack with other income sources and speed up city completions. Prioritize upgrading your vault early!" },
        ]
      },
      {
        title: "Gear System",
      ...
      },
      {
        title: "Pets",
        content: [
          { type: "list", items: ["Pets give extra All Profit % bonuses", "Open Pet Eggs from Pet Boxes or merged pets", "Rarities: Common → Rare → Epic → Legendary → Ultimate", "Stack pet food for bigger eggs and to level up big pets"] },
        ]
      },
      {
        title: "Clubs",
      ...
      },
      {
        title: "Gems Strategy",
        content: [
          { type: "list", items: ["Save gems early game for vault upgrades and event boxes", "Do NOT buy the 2x/5x shop boosts with gems", "If buying boosts, watch an ad first then buy both together for max multiplier"] },
        ]
      },
      {
