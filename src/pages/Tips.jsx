  ...
  return (
    <div className="min-h-screen bg-background font-inter">
      ...
      <div className="pt-16 pb-20 px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 rounded-2xl border border-border/50 bg-card/65 backdrop-blur-sm p-5 sm:p-6 shadow-[0_14px_34px_rgba(59,130,246,0.12)]">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {tips.map((tip, i) => (
            <motion.div
              ...
              className="bg-card/85 border border-border/45 rounded-2xl p-5 hover:border-primary/35 hover:shadow-[0_10px_26px_rgba(59,130,246,0.14)] transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="mt-10 p-5 rounded-2xl bg-gradient-to-r from-primary/15 via-sky-400/10 to-accent/15 border border-primary/25 text-center shadow-[0_12px_30px_rgba(59,130,246,0.16)]"
        >
