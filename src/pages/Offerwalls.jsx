  ...
  return (
    <div className="min-h-screen bg-background font-inter">
      ...
      <div className="pt-24 pb-20 px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-foreground mb-6">Offerwalls</h1>
        <p className="text-muted-foreground leading-relaxed">
          Coming soon — a comprehensive guide to the best offerwalls available on GPT sites. 
