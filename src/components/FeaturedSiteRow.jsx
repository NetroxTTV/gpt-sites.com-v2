...
const rewardIcons = {
  ...
  Bitcoin: { label: "₿", bg: "bg-orange-500" },
  Litecoin: { label: "Ł", bg: "bg-gray-500" },
    ...
    >
      <div className="relative rounded-2xl bg-card border border-border/50 hover:border-primary/40 transition-all duration-300 overflow-hidden group">
        ...
        <div className="absolute top-4 left-4 z-10">
          <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-bold bg-gradient-to-r ${rankColors[rank]} text-white shadow-lg`}>
            #{rank} Featured
          </span>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex flex-col items-center justify-center p-8 md:w-52 md:border-r border-border/30 bg-secondary/20 flex-shrink-0">
            ...
            {site.bonus_tag && (
              <span className="mt-2 px-2 py-0.5 rounded-full text-[10px] font-bold bg-accent/20 text-accent border border-accent/30">
                {site.bonus_tag}
              </span>
            )}
          </div>
